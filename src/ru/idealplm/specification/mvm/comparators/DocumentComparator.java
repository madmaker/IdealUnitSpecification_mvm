...
public class DocumentComparator implements Comparator<BlockLine>{
	...
	public int compare(BlockLine bl0, BlockLine bl1) {
		boolean bl0_is_base = specification.getStringProperty("OBOZNACH").equals(bl0.getId().substring(0, bl0.getId().lastIndexOf(" ")));
		boolean bl1_is_base = specification.getStringProperty("OBOZNACH").equals(bl1.getId().substring(0, bl1.getId().lastIndexOf(" ")));
